...
export const ConsciousSendIcon = ({
  className = "",
}: {
  className?: string;
}) => (
...
export const ThoughtWaveSendIcon = ({
  className = "",
}: {
  className?: string;
}) => (
  ...
  >
    ...
    {/* Send arrow */}
    <path d="M30 18L8 8v6l14 4-14 4v6l22-10z" fill="url(#waveGradient)" />
    {/* Thought waves */}
    <path
...
export const SparkleSendIcon = ({ className = "" }: { className?: string }) => (
  ...
  >
    ...
    {/* Send arrow */}
    <path d="M30 18L10 8v6l12 4-12 4v6l20-10z" fill="url(#sparkleGradient)" />
    {/* Conscious sparkles */}
    <g opacity="0.8">
      <path
...
export const NeuralSendIcon = ({ className = "" }: { className?: string }) => (
  ...
  >
    ...
    <path d="M20 18L14 15v2l4 1-4 1v2l6-3z" fill="url(#neuralGradient)" />
    <path d="M32 18L20 12v4l8 2-8 2v4l12-6z" fill="url(#neuralGradient)" />
  </svg>
);

// Option 5: Send simple mais conscient (minimaliste)
export const MinimalConsciousSendIcon = ({
  className = "",
}: {
  className?: string;
}) => (
